...
import { useLendCryptoPageSlice } from './slice';
...
export default function LendCryptoResult() {
  ...
  const { actions, sagaActions } = useLendCryptoPageSlice();
  const { isFilterbarOpen, filterOption, list, collateral, loan } =
